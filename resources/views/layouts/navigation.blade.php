...
@if($role === 'admin')
            ...
            @if(request()->route('jurusan'))
                ...
                <details class="sb-group sb-group--nested" open>
                    ...
                    <div class="sb-sub sb-sub--nested">
                        <a href="{{ route('admin.jurusan.show', $jrs) }}"              class="sb-item {{ request()->routeIs('admin.jurusan.show') ? 'active' : '' }}">Overview</a>
                        <a href="{{ route('admin.jurusan.kurikulum.index', $jrs) }}"   class="sb-item {{ request()->routeIs('admin.jurusan.kurikulum.*') ? 'active' : '' }}">Kurikulum</a>
                        <a href="{{ route('admin.jurusan.kompetensi.index', $jrs) }}"  class="sb-item {{ request()->routeIs('admin.jurusan.kompetensi.*') ? 'active' : '' }}">Kompetensi</a>
                        <a href="{{ route('admin.jurusan.prospek-kerja.index', $jrs) }}" class="sb-item {{ request()->routeIs('admin.jurusan.prospek-kerja.*') ? 'active' : '' }}">Prospek Kerja</a>
                        <a href="{{ route('admin.jurusan.fasilitas.index', $jrs) }}"   class="sb-item {{ request()->routeIs('admin.jurusan.fasilitas.*') ? 'active' : '' }}">Fasilitas</a>
                    </div>
                </details>
            @endif
        </div>
    ...
    <details class="sb-group" {{ request()->routeIs('admin.kenaikan-kelas.*') ? 'open' : '' }}>
        ...
        <div class="sb-sub">
            <a href="{{ route('admin.kenaikan-kelas.index') }}"  class="sb-item {{ request()->routeIs('admin.kenaikan-kelas.index') ? 'active' : '' }}">Riwayat Proses</a>
            <a href="{{ route('admin.kenaikan-kelas.create') }}" class="sb-item {{ request()->routeIs('admin.kenaikan-kelas.create') ? 'active' : '' }}">+ Proses Baru</a>
            @if(request()->route('kenaikan_kelas'))
                ...
                <details class="sb-group sb-group--nested" open>
                    ...
                    <div class="sb-sub sb-sub--nested">
                        <a href="{{ route('admin.kenaikan-kelas.show', $kk) }}" class="sb-item {{ request()->routeIs('admin.kenaikan-kelas.show') ? 'active' : '' }}">Detail Batch</a>
                        @if(! $kk->isSelesai() && ! $kk->isDibatalkan())
                            ...
                            onclick="return confirm('Batalkan proses ini?')">Batalkan</a>
                        @endif
                    </div>
                </details>
            @endif
    ...
    <details class="sb-group" {{ request()->routeIs('admin.absensi.*','admin.sesi-qr.*','admin.riwayat-scan.*') ? 'open' : '' }}>
        ...
        <div class="sb-sub">
            ...
            <a href="{{ route('admin.sesi-qr.index') }}"      class="sb-item {{ request()->routeIs('admin.sesi-qr.*') ? 'active' : '' }}">Sesi QR Kelas</a>
    ...
    <details class="sb-group" {{ request()->routeIs('admin.laporan.*') ? 'open' : '' }}>
        ...
        <div class="sb-sub">
            ...
            {{-- [BARU] Absensi Gerbang dipisah dari Absensi Kelas --}}
            <a href="{{ route('admin.laporan.absensi-gerbang') }}"    class="sb-item {{ request()->routeIs('admin.laporan.absensi-gerbang*') ? 'active' : '' }}">Absensi Gerbang</a>
            <a href="{{ route('admin.laporan.absensi') }}"            class="sb-item {{ request()->routeIs('admin.laporan.absensi*') ? 'active' : '' }}">Absensi Kelas</a>
            ...
            <a href="{{ route('admin.laporan.jurnal-mengajar') }}"    class="sb-item {{ request()->routeIs('admin.laporan.jurnal-mengajar*') ? 'active' : '' }}">Jurnal Mengajar</a>
            <a href="{{ route('admin.laporan.log-piket') }}"          class="sb-item {{ request()->routeIs('admin.laporan.log-piket*') ? 'active' : '' }}">Log Piket</a>
            <a href="{{ route('admin.laporan.ujian') }}"              class="sb-item {{ request()->routeIs('admin.laporan.ujian*') ? 'active' : '' }}">Laporan Ujian</a>
            <a href="{{ route('admin.laporan.izin-keluar') }}"        class="sb-item {{ request()->routeIs('admin.laporan.izin-keluar*') ? 'active' : '' }}">Izin Keluar Siswa</a>
        </div>
    </details>
...
@elseif($role === 'guru')
    ...
    {{--
        [DIPERBARUI] Absensi Kelas — QR session sesuai jadwal guru sendiri.
...
@elseif($role === 'guru_piket')
    ...
    <details class="sb-group" {{ request()->routeIs('piket.sesi-gerbang.*') ? 'open' : '' }}>
        <summary class="sb-group-header">
            <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/>
                <polyline points="10 17 15 12 10 7"/>
    ...
    {{-- Monitor Scan Masuk / Pulang --}}
    <details class="sb-group" {{ request()->routeIs('piket.absensi-gerbang.*') ? 'open' : '' }}>
        <summary class="sb-group-header">
            <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <rect x="3" y="4" width="18" height="18" rx="2"/>
                <line x1="16" y1="2" x2="16" y2="6"/>
...
@elseif($role === 'siswa')
    ...
    {{--
        [BARU] Barcode Saya — akses cepat dari menu Utama karena digunakan setiap hari.
        Menampilkan 2 jenis barcode:
          1. Barcode Tetap  → untuk scan alat di gerbang (masuk & pulang), tidak berubah
          2. QR Kelas       → untuk absensi per pelajaran (berganti tiap sesi, dibuat guru)
    --}}
    <a href="{{ route('siswa.barcode.index') }}"
    class="sb-item {{ request()->routeIs('siswa.barcode.*') ? 'active' : '' }}">
        <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            <rect x="3" y="3" width="5" height="5"/>
            <rect x="16" y="3" width="5" height="5"/>
            <rect x="3" y="16" width="5" height="5"/>
    ...
    {{-- ── KEHADIRAN ─────────────────────────────────────── --}}
    <p class="sb-section">Kehadiran</p>

    {{--
        [DIPERBARUI] Seksi Absensi dipecah menjadi 2 sub-grup yang lebih jelas:
        1. Absensi Gerbang — rekam masuk/pulang via barcode tetap di alat piket
        2. Absensi Kelas   — QR per pelajaran yang dibuat oleh guru
    --}}
    <details class="sb-group" {{ request()->routeIs('siswa.absensi-gerbang.*') ? 'open' : '' }}>
        <summary class="sb-group-header">
            <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/>
                <polyline points="10 17 15 12 10 7"/>
        ...
        <div class="sb-sub">
            {{-- Menampilkan status scan masuk/pulang hari ini --}}
            <a href="{{ route('siswa.absensi-gerbang.status-hari-ini') }}"
            class="sb-item {{ request()->routeIs('siswa.absensi-gerbang.status-hari-ini') ? 'active' : '' }}">
                Status Hari Ini
            </a>
            <a href="{{ route('siswa.absensi-gerbang.riwayat') }}"
            class="sb-item {{ request()->routeIs('siswa.absensi-gerbang.riwayat') ? 'active' : '' }}">
                Riwayat Masuk & Pulang
            </a>
        </div>
    </details>
...
@elseif($role === 'orang_tua')
    ...
    {{-- Tidak ada perubahan signifikan di role orang_tua karena mereka
         hanya observer — kehadiran anak di seksi "Pantau Anak" sudah cukup.
         Namun status gerbang bisa ditambah jika diperlukan di masa depan. --}}
    ...
    {{--
        [DIPERBARUI] Kehadiran Anak — kini menampilkan status gerbang (masuk/pulang)
        sebagai informasi utama karena paling relevan untuk orang tua.
    --}}
    <details class="sb-group" {{ request()->routeIs('ortu.absensi.*','ortu.kehadiran-gerbang.*') ? 'open' : '' }}>
        <summary class="sb-group-header">
            <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <rect x="3" y="4" width="18" height="18" rx="2"/>
                <line x1="16" y1="2" x2="16" y2="6"/>
        ...
        <div class="sb-sub">
            {{-- [BARU] Status gerbang hari ini: sudah masuk jam berapa, sudah pulang? --}}
            <a href="{{ route('ortu.kehadiran-gerbang.status-hari-ini') }}"
            class="sb-item {{ request()->routeIs('ortu.kehadiran-gerbang.status-hari-ini') ? 'active' : '' }}">
                Status Gerbang Hari Ini
            </a>
            <a href="{{ route('ortu.absensi.status-hari-ini') }}" class="sb-item {{ request()->routeIs('ortu.absensi.status-hari-ini') ? 'active' : '' }}">Status Kelas Hari Ini</a>
