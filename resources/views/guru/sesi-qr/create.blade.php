...
<style>
    ...
    *{box-sizing:border-box}
    ...
    /* GPS section */
    .gps-toggle{display:flex;align-items:center;gap:8px;padding:10px 14px;background:var(--surface2);border:1px solid var(--border);border-radius:var(--radius-sm);cursor:pointer;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:700;color:var(--text2);transition:all .15s;user-select:none}
    .gps-toggle:hover{background:var(--brand-50);border-color:var(--brand-100);color:var(--brand-600)}
    .gps-panel{display:none;margin-top:10px;padding:14px;background:var(--brand-50);border:1px solid var(--brand-100);border-radius:var(--radius-sm)}
    .gps-panel.open{display:block}
    ...
    /* Empty jadwal */
    .empty-jadwal{text-align:center;padding:32px 16px;background:var(--surface2);border-radius:var(--radius-sm);border:1px dashed var(--border2)}
...
<div class="page">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="field-row">
                <div class="field">
                    <label class="field-label" for="durasi_menit">
                        Durasi Sesi
                    </label>
                ...
                <div class="field">
                    <label class="field-label" for="radius_meter">
                        Radius Lokasi
                    </label>
                    <div class="preset-row">
