        ...
        <div class="form-card">
            ...
            <div class="form-card-body grid-2">
                ...
                <div class="field">
                    ...
                    <select name="mata_pelajaran_id" class="{{ $errors->has('mata_pelajaran_id') ? 'is-invalid' : '' }}">
                        ...
                        @foreach($mapelList as $m)
                            <option value="{{ $m->id }}" {{ old('mata_pelajaran_id', $tugas->mata_pelajaran_id) == $m->id ? 'selected' : '' }}>{{ $m->nama_mapel }}</option>
                        @endforeach
                    </select>
                ...
                <div class="field">
                    ...
                    <select name="tahun_ajaran_id" class="{{ $errors->has('tahun_ajaran_id') ? 'is-invalid' : '' }}">
                        ...
                        @foreach($tahunAjaran as $t)
                            <option value="{{ $t->id }}" {{ old('tahun_ajaran_id', $tugas->tahun_ajaran_id) == $t->id ? 'selected' : '' }}>{{ $t->tahun }}</option>
                        @endforeach
                    </select>
                ...
                <div class="field span-2">
                    ...
                    <textarea name="deskripsi" placeholder="Jelaskan instruksi pengerjaan tugas…">{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                </div>
            </div>
        </div>
                    ...
                    <label class="jenis-option">
                        ...
                        <div class="jenis-card">
                            <div class="jenis-card-icon">
                                ...
                                @elseif($j==='teks')<svg width="16" height="16" fill="none" stroke="#15803d" stroke-width="2" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                @elseif($j==='link')<svg width="16" height="16" fill="none" stroke="#a16207" stroke-width="2" viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
                                @else<svg width="16" height="16" fill="none" stroke="#7c3aed" stroke-width="2" viewBox="0 0 24 24"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>@endif
                            </div>
            ...
            <div class="form-card-body grid-2">
                <div class="field span-2">
                    ...
                    <div class="existing-file">
                        ...
                        <a href="{{ Storage::url($tugas->path_file_soal) }}" target="_blank" class="btn btn-secondary" style="padding:4px 10px;font-size:11.5px">Lihat</a>
                    </div>
                    @endif
                    <label>{{ $tugas->path_file_soal ? 'Ganti File Soal' : 'Upload File Soal' }} <span class="hint">opsional · maks. 10MB</span></label>
                ...
                <div class="field">
                    ...
                    <input type="number" name="nilai_maksimal" value="{{ old('nilai_maksimal', $tugas->nilai_maksimal ?? 100) }}" min="0" max="100" step="0.5">
            ...
            <div class="form-card-body" style="gap:10px">
                <div class="toggle-row">
                    ...
                    <label class="toggle-switch">
                        <input type="checkbox" name="izinkan_terlambat" value="1" {{ old('izinkan_terlambat', $tugas->izinkan_terlambat) ? 'checked' : '' }}>
                ...
                <div class="toggle-row">
                    ...
                    <label class="toggle-switch">
                        <input type="checkbox" name="dipublikasikan" value="1" {{ old('dipublikasikan', $tugas->dipublikasikan) ? 'checked' : '' }}>
                        <span class="toggle-slider"></span>
                    </label>
                </div>
            </div>
