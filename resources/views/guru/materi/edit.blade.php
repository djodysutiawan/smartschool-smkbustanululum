...
<div class="page">
    ...
    <form action="{{ route('guru.materi.update', $materi->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="jenis-option">
                        ...
                        <div class="jenis-card">
                            <div class="jenis-card-icon">
                                ...
                                @elseif($j==='video')<svg width="16" height="16" fill="none" stroke="#7c3aed" stroke-width="2" viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>
                                ...
                                @else<svg width="16" height="16" fill="none" stroke="#15803d" stroke-width="2" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>@endif
                            </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <div class="toggle-row">
                    <div>
                        <p class="toggle-label">Publikasikan Materi</p>
        ...
        <div style="display:flex;gap:10px;justify-content:flex-end;margin-top:4px">
            <a href="{{ route('guru.materi.show', $materi->id) }}" class="btn btn-secondary">Batal</a>
