...
<div class="page">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Isi form di bawah untuk menambahkan jadwal pelajaran baru</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.schedules.store') }}" id="scheduleForm">
        ...
        <div class="form-card">
            ...
            <div class="card-body">
                    ...
                    <div class="day-picker">
                        @foreach(['Senin','Selasa','Rabu','Kamis','Jumat','Sabtu'] as $hari)
                            <input type="radio" name="hari" id="hari_{{ $hari }}" value="{{ $hari }}"
                                class="day-opt" onchange="updateSummary()"
                ...
                {{-- Jam --}}
                <div class="form-group">
                    <label class="form-label">Jam Pelajaran <span class="req">*</span></label>
                    <div class="time-row">
                        <div>
    ...
    {{-- Summary card (live preview ringkasan) --}}
    <div class="summary-card" id="summaryCard">
        ...
        <div class="summary-grid">
            <div>
                ...
                <p class="summary-item-val" id="sumMapel">—</p>
            </div>
            <div>
                <p class="summary-item-label">Kelas</p>
                <p class="summary-item-val" id="sumKelas">—</p>
            </div>
            <div>
                <p class="summary-item-label">Guru</p>
                <p class="summary-item-val" id="sumGuru">—</p>
            </div>
            <div>
                <p class="summary-item-label">Hari</p>
                <p class="summary-item-val" id="sumHari">—</p>
            </div>
            <div>
                <p class="summary-item-label">Jam</p>
                <p class="summary-item-val" id="sumJam">—</p>
            </div>
            <div>
...
<script>
    ...
    function updateDuration() {
        ...
        const icon    = document.getElementById('durIcon');
        ...
        preview.classList.add('visible');
        const str = durStr(diff);
        document.getElementById('durationText').textContent = 'Durasi pelajaran: ' + str;
        updateSummary();
    }
    ...
    function updateSummary() {
        ...
        const hasAny = mapel || kelas || guru || hari || mulai || selesai;
        ...
        if (mulai && selesai) {
            ...
            document.getElementById('sumJam').textContent    = mulai || selesai ? (mulai || '?') + ' – ' + (selesai || '?') : '—';
