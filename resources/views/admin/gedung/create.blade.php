...
<div class="page">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Isi semua data gedung dengan benar, lalu klik Simpan Data</p>
        </div>
    ...
    <form action="{{ route('admin.gedung.store') }}" method="POST" id="gedungForm">
        @csrf
        <div class="form-card">
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input type="text" name="nama_gedung" value="{{ old('nama_gedung') }}"
                            placeholder="cth. Gedung A, Gedung Utama"
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="kode_gedung" value="{{ old('kode_gedung') }}"
                            placeholder="cth. GDG-A (maks. 10 karakter)"
                            maxlength="10"
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="jumlah_lantai" value="{{ old('jumlah_lantai', 1) }}"
                            min="1" max="20"
            ...
            <div class="form-footer">
                <a href="{{ route('admin.gedung.index') }}" class="btn btn-cancel">Batal</a>
