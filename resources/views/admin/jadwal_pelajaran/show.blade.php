...
<div class="page">
    ...
    <div class="page-header">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            {{-- Tombol Generate QR — dari method generateQr() di controller --}}
            ...
            @endif
            {{-- Toggle status — dari method toggleStatus() --}}
    ...
    {{-- Alert sesi QR aktif — dari $stats['ada_sesi_aktif'] --}}
    ...
    {{-- Stats strip — semua dari $stats controller --}}
        ...
        <div class="detail-card">
            ...
            <div class="drow">
                ...
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:2px;">
                    <span class="hari-pill hari-{{ $jadwalPelajaran->hari }}">{{ ucfirst($jadwalPelajaran->hari) }}</span>
                    <span>
    ...
    {{-- Riwayat Sesi QR — dari $jadwalPelajaran->sesiQr (load limit 10) --}}
    <div class="detail-card">
        <div class="detail-header">
            ...
            <p class="detail-header-title">
                Riwayat Sesi QR
                <span class="detail-header-sub">({{ $jadwalPelajaran->sesiQr->count() }} terakhir)</span>
            </p>
        </div>
        ...
        <div style="overflow-x:auto;">
            <table class="sesi-table">
                ...
                <tbody>
                    ...
                    @php
                        $totalSiswa    = optional($jadwalPelajaran->kelas)->siswa->count() ?? 0;
