...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <span class="current">Tambah Jadwal Piket</span>
    </nav>

    <div class="page-header">
        <div>
            <h1 class="page-title">Tambah Jadwal Piket Guru</h1>
            <p class="page-sub">Tentukan guru piket, hari, dan jam bertugas</p>
        </div>
    ...
    <form action="{{ route('admin.jadwal-piket-guru.store') }}" method="POST" id="formPiket">
        ...
        <div class="form-card">
            ...
            <div class="form-footer">
                <a href="{{ route('admin.jadwal-piket-guru.index') }}" class="btn btn-cancel">Batal</a>
