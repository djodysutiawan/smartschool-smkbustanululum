...
<style>
    ...
    .pw-strength-text { font-size: 11.5px; font-family: 'DM Sans', sans-serif; }
        ...
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="field">
                        ...
                        <span class="field-hint">Password akan digunakan orang tua untuk login ke sistem</span>
                    </div>
                    <div class="field col-span-2">
                        <label>Alamat</label>
            ...
            <div class="form-section">
                ...
                <span class="field-hint" style="display:block;margin-bottom:14px">
                    Hubungkan orang tua ini ke satu atau lebih siswa. Field ini opsional dan dapat diisi belakangan.
                </span>
                ...
                <div class="student-rows" id="studentRows">
                    @if(old('students'))
                        @foreach(old('students') as $i => $sid)
                            <div class="student-row">
                                <select name="students[]">
                                    <option value="">— Pilih Siswa —</option>
                                    @foreach($students as $student)
                                        <option value="{{ $student->id }}" {{ $sid == $student->id ? 'selected' : '' }}>
                                            {{ $student->nama_lengkap }}
                                        </option>
                                    @endforeach
                                </select>
                                <input type="text" name="hubungan[]"
                                    value="{{ old('hubungan')[$i] ?? '' }}"
                ...
                {{-- Empty placeholder --}}
                <div class="empty-students" id="emptyStudents" style="{{ old('students') ? 'display:none' : '' }}">
