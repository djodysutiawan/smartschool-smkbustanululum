...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <a href="{{ route('admin.kelas.show', $kelas->id) }}">{{ $kelas->nama_kelas }}</a>
        <span class="sep">›</span>
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Perbarui data kelas {{ $kelas->nama_kelas }} ({{ $kelas->kode_kelas }})</p>
        </div>
        <a href="{{ route('admin.kelas.show', $kelas->id) }}" class="btn btn-back">
    ...
    <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST" id="kelasForm">
        ...
        <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="field">
                        ...
                        <select name="status" class="{{ $errors->has('status') ? 'is-invalid' : '' }}">
                            ...
                            <option value="nonaktif" {{ old('status', $kelas->status) == 'nonaktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
            ...
            <div class="form-footer">
                <a href="{{ route('admin.kelas.show', $kelas->id) }}" class="btn btn-cancel">Batal</a>
