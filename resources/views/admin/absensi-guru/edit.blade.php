...
<style>
    ...
    .info-badge{display:inline-block;padding:4px 12px;border-radius:6px;background:var(--brand-50);color:var(--brand-700);font-family:'Plus Jakarta Sans',sans-serif;font-size:12.5px;font-weight:700;border:1px solid var(--brand-100)}
...
<div class="page">
    <nav class="breadcrumb">
        ...
        <a href="{{ route('admin.absensi-guru.show', $absensiGuru->id) }}">Detail</a><span class="sep">›</span>
    ...
    <form action="{{ route('admin.absensi-guru.update', $absensiGuru->id) }}" method="POST" enctype="multipart/form-data" id="editForm">
        @csrf @method('PUT')
        <div class="form-card">
            <div class="form-section">
                ...
                <div class="form-grid" style="margin-bottom:16px">
                    <div class="field">
                        <label>Guru</label>
                        <div class="info-badge">{{ $absensiGuru->guru->nama_lengkap ?? '—' }}</div>
                    </div>
                    <div class="field">
                        <label>Tanggal</label>
                ...
                <div class="form-grid">
                    ...
                    <div class="field col-span-2">
                        ...
                        <textarea name="keterangan" rows="3" placeholder="Catatan tambahan..."
                            class="{{ $errors->has('keterangan') ? 'is-invalid' : '' }}">{{ old('keterangan', $absensiGuru->keterangan) }}</textarea>
