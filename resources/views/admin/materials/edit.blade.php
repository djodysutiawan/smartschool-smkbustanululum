...
<style>
    ...
    .file-existing-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
    .file-existing-link {
    ...
    .file-existing-link:hover { background: var(--brand-100); }
    ...
    .file-drop-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13.5px; font-weight: 700; color: var(--text2); }
    .file-drop-sub   { font-family: 'DM Sans', sans-serif; font-size: 12px; color: var(--text3); margin-top: 4px; }
    ...
    .file-preview-size { font-family: 'DM Sans', sans-serif; font-size: 11.5px; color: var(--text3); flex-shrink: 0; }
    .file-clear {
...
<div class="page">
    ...
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <span class="current">Edit Materi</span>
    </nav>
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">{{ $material->judul }}</p>
        </div>
            ...
            <div class="form-card-body">
                ...
                <div class="form-group" style="margin-bottom:18px">
                    ...
                    <textarea id="deskripsi" name="deskripsi"
                        ...
                        placeholder="Tuliskan deskripsi singkat materi ini…">{{ old('deskripsi', $material->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <span class="form-error">
                            <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                            {{ $message }}
                ...
                <div class="form-grid col-3" style="margin-bottom:0">
                ...
                <div class="form-group">
                    ...
                    <p class="form-hint">Opsional. Kosongkan jika tidak ingin mengganti file yang ada.</p>

                    {{-- File lama (jika ada) --}}
                    @if($material->file_path)
                        <div class="file-existing" id="fileExisting">
                            ...
                            <div class="file-existing-info">
                                <p class="file-existing-name">
                                    {{ basename($material->file_path) }}
                                </p>
                                <p class="file-existing-sub">File tersimpan · Upload baru akan menggantikan file ini</p>
                            </div>
                            <div class="file-existing-actions">
                                <a href="{{ asset('storage/' . $material->file_path) }}"
                                    target="_blank" class="file-existing-link">
                    ...
                    <div class="file-drop {{ $errors->has('file') ? 'is-invalid' : '' }}"
                        ...
                        <div id="fileDropContent">
                            <div class="file-drop-icon">
                                <svg width="18" height="18" fill="none" stroke="#94a3b8" stroke-width="1.5" viewBox="0 0 24 24">
                                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                                    <polyline points="17 8 12 3 7 8"/>
                                    <line x1="12" y1="3" x2="12" y2="15"/>
                                </svg>
                            </div>
                            <p class="file-drop-title">
                                {{ $material->file_path ? 'Klik atau seret file untuk mengganti' : 'Klik atau seret file ke sini' }}
                            </p>
                    ...
                    <div class="file-preview" id="filePreview">
                        ...
                        <button type="button" class="file-clear" onclick="clearFile()" title="Batalkan penggantian">
