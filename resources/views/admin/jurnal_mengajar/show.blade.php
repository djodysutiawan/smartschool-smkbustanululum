...
<style>
    ...
    .prose-box{background:var(--surface2);border:1px solid var(--border);border-radius:var(--radius-sm);padding:14px;font-family:'DM Sans',sans-serif;font-size:13.5px;color:var(--text);line-height:1.7;white-space:pre-line}
...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <span class="current">Detail Jurnal</span>
    </nav>

    <div class="page-header">
        <div>
            <h1 class="page-title">Detail Jurnal Mengajar</h1>
            <p class="page-sub">{{ \Carbon\Carbon::parse($jurnalMengajar->tanggal)->translatedFormat('l, d F Y') }}</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.jurnal-mengajar.edit', $jurnalMengajar->id) }}" class="btn btn-edit">
        ...
        <div>
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="card-title">Informasi Mengajar</span>
                </div>
                <div class="card-body">
                    <div class="dl-grid">
                        <div class="dl-item">
                            <p class="dl-label">Guru</p>
                            <p class="dl-val">{{ $jurnalMengajar->guru->nama_lengkap ?? '—' }}</p>
                        </div>
                        <div class="dl-item">
                            <p class="dl-label">Mata Pelajaran</p>
                            <p class="dl-val">{{ $jurnalMengajar->mataPelajaran->nama_mapel ?? '—' }}</p>
                        </div>
                        <div class="dl-item">
                            <p class="dl-label">Kelas</p>
                            <p class="dl-val">{{ $jurnalMengajar->kelas->nama_kelas ?? '—' }}</p>
                        </div>
                        <div class="dl-item">
                        ...
                        <div class="dl-item">
                            <p class="dl-label">Pertemuan Ke-</p>
                            <p class="dl-val">{{ $jurnalMengajar->pertemuan_ke ?? '—' }}</p>
                        </div>
                        <div class="dl-item">
                        ...
                        <div class="dl-item dl-full">
                            ...
                            <div class="prose-box" style="margin-top:6px">{{ $jurnalMengajar->catatan_kelas }}</div>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div>
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="card-title">Kehadiran Siswa</span>
                </div>
                <div class="card-body">
                    <div class="stat-mini-grid">
                        <div class="stat-mini">
                            <p class="stat-mini-val" style="color:#15803d">{{ $jurnalMengajar->jumlah_hadir ?? '—' }}</p>
                            <p class="stat-mini-label">Hadir</p>
                        </div>
                        <div class="stat-mini">
                            <p class="stat-mini-val" style="color:#dc2626">{{ $jurnalMengajar->jumlah_tidak_hadir ?? '—' }}</p>
                    ...
                    <div>
                        <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                            ...
                            <span style="font-family:'Plus Jakarta Sans',sans-serif;font-size:12px;font-weight:700;color:var(--text)">{{ $pct }}%</span>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="card-title">Informasi Entri</span>
                </div>
                <div class="card-body">
                    <div style="display:flex;flex-direction:column;gap:10px">
                        <div>
                            <p class="dl-label">Dibuat</p>
                            <p class="dl-val">{{ $jurnalMengajar->created_at->format('d M Y, H:i') }}</p>
                        </div>
                        <div>
                            <p class="dl-label">Diperbarui</p>
                            <p class="dl-val">{{ $jurnalMengajar->updated_at->format('d M Y, H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
