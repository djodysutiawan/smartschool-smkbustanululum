...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <a href="{{ route('admin.jurnal-mengajar.show', $jurnalMengajar->id) }}">Detail</a>
        <span class="sep">›</span>
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Perbarui data jurnal mengajar — {{ \Carbon\Carbon::parse($jurnalMengajar->tanggal)->format('d M Y') }}</p>
        </div>
        <a href="{{ route('admin.jurnal-mengajar.show', $jurnalMengajar->id) }}" class="btn btn-back">
    ...
    <form action="{{ route('admin.jurnal-mengajar.update', $jurnalMengajar->id) }}" method="POST" id="jurnalForm">
        ...
        <div class="form-card">
            ...
            <div class="form-footer">
                <a href="{{ route('admin.jurnal-mengajar.show', $jurnalMengajar->id) }}" class="btn btn-cancel">Batal</a>
