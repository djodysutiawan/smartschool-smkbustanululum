...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <a href="{{ route('admin.kategori-pelanggaran.show', $kategoriPelanggaran->id) }}">{{ $kategoriPelanggaran->nama }}</a>
        <span class="sep">›</span>
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Edit Kategori Pelanggaran</h1>
            <p class="page-sub">Perbarui data kategori "{{ $kategoriPelanggaran->nama }}"</p>
        </div>
        <a href="{{ route('admin.kategori-pelanggaran.show', $kategoriPelanggaran->id) }}" class="btn btn-back">
    ...
    <form action="{{ route('admin.kategori-pelanggaran.update', $kategoriPelanggaran->id) }}" method="POST" id="katForm">
        ...
        <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="poin_default" id="poinDefault"
                            value="{{ old('poin_default', $kategoriPelanggaran->poin_default) }}"
                            min="1" max="100"
                    ...
                    <div class="field">
                        ...
                        <div class="poin-preview">
                            <span class="poin-val" id="poinPreview">{{ old('poin_default', $kategoriPelanggaran->poin_default) }}</span>
                    ...
                    <div class="field col-span-2">
                        ...
                        <textarea name="deskripsi" rows="3"
                            ...
                            class="{{ $errors->has('deskripsi') ? 'is-invalid' : '' }}">{{ old('deskripsi', $kategoriPelanggaran->deskripsi) }}</textarea>
            ...
            <div class="form-footer">
                <a href="{{ route('admin.kategori-pelanggaran.show', $kategoriPelanggaran->id) }}" class="btn btn-cancel">Batal</a>
