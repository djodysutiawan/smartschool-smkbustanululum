...
<div class="page">
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <a href="{{ route('admin.pelanggaran.show', $pelanggaran->id) }}">Detail #{{ $pelanggaran->id }}</a>
        <span class="sep">›</span>
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Edit Catatan Pelanggaran</h1>
            <p class="page-sub">Perbarui data pelanggaran {{ $pelanggaran->siswa->nama_lengkap ?? '' }}</p>
        </div>
        <a href="{{ route('admin.pelanggaran.show', $pelanggaran->id) }}" class="btn btn-back">
    ...
    <form action="{{ route('admin.pelanggaran.update', $pelanggaran->id) }}" method="POST" id="pelForm">
        ...
        <div class="form-card">
            ...
            <div class="form-footer">
                <a href="{{ route('admin.pelanggaran.show', $pelanggaran->id) }}" class="btn btn-cancel">Batal</a>
