...
<style>
    ...
    .alert {
        ...
        padding: 12px 16px; border-radius: var(--radius-sm); margin-bottom: 20px; font-size: 13.5px;
    }
...
<div class="page">
    ...
    <nav class="breadcrumb">
        ...
        <span class="sep">›</span>
        <span class="current">Edit Siswa</span>
    </nav>
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">{{ $student->nama_lengkap }} &mdash; NIS {{ $student->nis }}</p>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="field col-span-2">
                        ...
                        <span class="field-hint">Kosongkan jika tidak ingin mengubah password siswa</span>
                ...
                <div class="form-grid">
                    ...
                    <div class="field">
                        ...
                        <select name="agama" class="{{ $errors->has('agama') ? 'is-invalid' : '' }}">
                            ...
                            @foreach(['Islam','Kristen','Katolik','Hindu','Buddha','Konghucu'] as $ag)
                                <option value="{{ $ag }}" {{ old('agama', $student->agama) == $ag ? 'selected' : '' }}>
                                    {{ $ag }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="field col-span-2">
                        ...
                        <textarea name="alamat" rows="2"
                            ...
                            class="{{ $errors->has('alamat') ? 'is-invalid' : '' }}">{{ old('alamat', $student->alamat) }}</textarea>
                ...
                <div class="form-grid cols-3" style="margin-bottom:20px">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="no_hp_ayah"
                            value="{{ old('no_hp_ayah', $student->no_hp_ayah) }}"
                            placeholder="cth. 08123456789" inputmode="numeric"
                ...
                <div class="form-grid cols-3" style="margin-bottom:20px">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="no_hp_ibu"
                            value="{{ old('no_hp_ibu', $student->no_hp_ibu) }}"
                            placeholder="cth. 08123456789" inputmode="numeric"
            ...
            <div class="foto-section">
                <div class="foto-preview-wrap" id="previewWrap">
                    @if($student->foto)
                        <img id="previewImage" src="{{ asset('storage/' . $student->foto) }}" alt="{{ $student->nama_lengkap }}">
                ...
                <div class="foto-meta">
                    ...
                    <div class="foto-file-info">
                        <span class="foto-filename" id="fotoFilename">
                            {{ $student->foto ? 'Foto tersimpan' : 'Belum ada foto' }}
                        </span>
