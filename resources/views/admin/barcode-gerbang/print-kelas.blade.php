...
<body>
    ...
    @if($barcodes->isEmpty())
        <div class="empty-wrap">
            ...
            <p class="empty-sub">Belum ada siswa di kelas {{ $kelas->nama_kelas }} yang memiliki barcode aktif &amp; berlaku hari ini.<br>Silakan generate barcode terlebih dahulu.</p>
        </div>
    @else
