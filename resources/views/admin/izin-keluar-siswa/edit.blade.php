...
<style>
    ...
    *,*::before,*::after{box-sizing:border-box}
    ...
    /* ── Siswa preview ── */
    .siswa-preview{background:var(--surface2);border:1px solid var(--border);border-radius:var(--radius-sm);padding:10px 14px;margin-top:8px;display:flex;align-items:center;gap:10px}
...
<div class="page">
    ...
    <form action="{{ route('admin.izin-keluar-siswa.update', $izin->id) }}" method="POST" novalidate>
        @csrf
        @method('PUT')
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="form-grid cols-1">
                    <div class="field">
                        <label for="siswaSelect">Pilih Siswa<span class="req">*</span></label>
                        ...
                        {{-- Preview selalu ditampilkan (siswa sudah ada) --}}
                        <div class="siswa-preview" id="siswaPreview">
                            ...
                            <div>
                                ...
                                <p class="siswa-meta" id="previewMeta">
                                    Kelas: {{ $izin->siswa->kelas->nama_kelas ?? '—' }}&nbsp;&nbsp;·&nbsp;&nbsp;NIS: {{ $izin->siswa->nis ?? '—' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input type="date"
                               name="tanggal"
                               id="tanggal"
                               value="{{ old('tanggal', $izin->tanggal?->format('Y-m-d')) }}"
                    ...
                    <div class="field">
                        <label for="jamKeluar">Jam Keluar<span class="req">*</span></label>
                        <input type="time"
                               name="jam_keluar"
                               id="jamKeluar"
                    ...
                    <div class="field">
                        <label for="jamKembali">Rencana Jam Kembali</label>
                        <input type="time"
                               name="jam_kembali"
                               id="jamKembali"
                ...
                <div class="form-grid">
                    ...
                    <div class="field span-2">
                        ...
                        <textarea name="keterangan"
                                  id="keterangan"
                                  maxlength="1000"
                                  class="{{ $errors->has('keterangan') ? 'is-invalid' : '' }}">{{ old('keterangan', $izin->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="field-error">{{ $message }}</p>
                        @enderror
                    </div>
...
<script>
    ...
    // ── Siswa preview (update saat dropdown berubah) ──
    ...
    // Jalankan sekali saat load (untuk kasus old value dari validasi server)
    validateJamKembali();
</script>
</x-app-layout>