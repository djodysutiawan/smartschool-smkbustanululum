...
<style>
    ...
    .siswa-preview{background:var(--surface2);border:1px solid var(--border);border-radius:var(--radius-sm);padding:10px 14px;margin-top:8px;display:none}
...
<div class="page">
    ...
    <form action="{{ route('admin.izin-keluar-siswa.store') }}" method="POST">
        @csrf
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" class="{{ $errors->has('tanggal') ? 'error' : '' }}" required>
                    ...
                    <div class="field">
                        ...
                        <input type="time" name="jam_keluar" value="{{ old('jam_keluar') }}" class="{{ $errors->has('jam_keluar') ? 'error' : '' }}" required>
                        @error('jam_keluar') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="field">
                        <label>Rencana Jam Kembali</label>
                        <input type="time" name="jam_kembali" value="{{ old('jam_kembali') }}" class="{{ $errors->has('jam_kembali') ? 'error' : '' }}">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="field span-2">
                        ...
                        <input type="text" name="tujuan" value="{{ old('tujuan') }}" placeholder="Contoh: Ke dokter gigi, Rumah duka keluarga…" class="{{ $errors->has('tujuan') ? 'error' : '' }}" required maxlength="255">
                        @error('tujuan') <p class="field-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="field span-2">
                        <label>Keterangan Tambahan</label>
                        <textarea name="keterangan" placeholder="Informasi tambahan yang perlu diketahui…" maxlength="1000" class="{{ $errors->has('keterangan') ? 'error' : '' }}">{{ old('keterangan') }}</textarea>
