...
.existing-img { width:100%;border-radius:var(--radius-sm);margin-bottom:10px;max-height:120px;object-fit:cover;border:1px solid var(--border); }
...
<div class="page">
    <div class="breadcrumb">
        ...
        <a href="{{ route('admin.jurusan.show', $jurusan->id) }}">{{ $jurusan->nama }}</a>
        <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg>
        <span>Edit</span>
    </div>
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Perbarui data jurusan {{ $jurusan->nama }}</p>
        </div>
        <a href="{{ route('admin.jurusan.show', $jurusan->id) }}" class="btn btn-secondary">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-grid form-grid-2">
                                <div class="form-group">
                                    ...
                                    @if($jurusan->foto_kajur_path)
                                        <img src="{{ Storage::url($jurusan->foto_kajur_path) }}" class="existing-img">
                                    @elseif($jurusan->foto_kajur_url)
                                        <img src="{{ $jurusan->foto_kajur_url }}" class="existing-img">
                                    @endif
                                    <div class="upload-zone">
                                        ...
                                        <p class="upload-zone-text">Ganti Foto</p>
                    ...
                    <div class="form-card-body">
                        <div class="sidebar-section">
                            ...
                            @if($jurusan->foto_cover_path)
                                <img src="{{ Storage::url($jurusan->foto_cover_path) }}" class="existing-img">
                            @elseif($jurusan->foto_cover_url)
                                <img src="{{ $jurusan->foto_cover_url }}" class="existing-img">
                            @endif
                            <div class="upload-zone">
                                ...
                                <p class="upload-zone-text">Ganti Cover</p>
                        ...
                        <div class="sidebar-section">
                            ...
                            @if($jurusan->logo_path)
                                <img src="{{ Storage::url($jurusan->logo_path) }}" class="existing-img">
                            @elseif($jurusan->logo_url)
                                <img src="{{ $jurusan->logo_url }}" class="existing-img">
                            @endif
                            <div class="upload-zone">
                                <input type="file" name="logo" accept="image/*" onchange="previewImg(this,'prevLogo')">
                                <div class="upload-zone-icon"><svg width="16" height="16" fill="none" stroke="#94a3b8" stroke-width="1.8" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5z"/></svg></div>
                                <p class="upload-zone-text">Ganti Logo</p>
                    ...
                    <div class="form-card-body">
                        <div class="toggle-switch">
                            ...
                            <label class="switch">
                                ...
                                <input type="checkbox" name="is_published" value="1" {{ old('is_published', $jurusan->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="toggle-switch">
                            <div>
                                ...
                                <p class="toggle-sub">Buka pendaftaran jurusan</p>
                            </div>
                            <label class="switch">
                                <input type="hidden" name="is_penerimaan_buka" value="0">
                                <input type="checkbox" name="is_penerimaan_buka" value="1" {{ old('is_penerimaan_buka', $jurusan->is_penerimaan_buka) ? 'checked' : '' }}>
                                <span class="slider-sw"></span>
                            </label>
                        </div>
                    </div>
