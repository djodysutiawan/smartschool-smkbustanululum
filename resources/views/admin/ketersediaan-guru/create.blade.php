        ...
        <div class="form-card">
            <div class="form-section">
                ...
                <div class="info-box" style="margin-top:16px">
                    ...
                    <p><strong>Catatan:</strong> Slot dengan guru, hari, dan jam mulai yang sama tidak dapat diduplikasi. Gunakan fitur <strong>Bulk Slot</strong> pada halaman per-guru untuk mengatur banyak slot sekaligus.</p>
                </div>
            </div>
