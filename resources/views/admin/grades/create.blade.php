...
<style>
    ...
    .btn {
        ...
        cursor: pointer; border: none; text-decoration: none; transition: background .15s; white-space: nowrap;
    }
    ...
    /* Nilai input dengan warna dinamis */
...
<div class="page">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Input nilai tugas, UTS, dan UAS siswa</p>
        </div>
    ...
    <div class="preview-card">
        <div>
            ...
            <p class="preview-value" id="prevValue">0.00</p>
            <p class="preview-formula">30% Tugas + 30% UTS + 40% UAS</p>
        </div>
        <span class="preview-badge" id="prevBadge" style="background:var(--surface3); color:var(--text3); border:1px solid var(--border)">—</span>
    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="teacher_id" name="teacher_id" class="form-select {{ $errors->has('teacher_id') ? 'is-invalid' : '' }}">
                            ...
                            @foreach($teachers as $t)
                                <option value="{{ $t->id }}" {{ old('teacher_id') == $t->id ? 'selected' : '' }}>{{ $t->nama_lengkap }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-grid col-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="nilai-input-wrap">
                            ...
                            <span class="nilai-badge" id="badge_tugas" style="display:none"></span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="nilai-input-wrap">
                            <input type="number" id="nilai_uts" name="nilai_uts" min="0" max="100" step="0.01"
                                ...
                                value="{{ old('nilai_uts') }}"
                                placeholder="0 – 100" oninput="recalc()">
                            <span class="nilai-badge" id="badge_uts" style="display:none"></span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="nilai-input-wrap">
                            <input type="number" id="nilai_uas" name="nilai_uas" min="0" max="100" step="0.01"
                                ...
                                value="{{ old('nilai_uas') }}"
                                placeholder="0 – 100" oninput="recalc()">
                            <span class="nilai-badge" id="badge_uas" style="display:none"></span>
                        </div>
