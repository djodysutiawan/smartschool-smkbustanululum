...
<style>
    ...
    .meta-row { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid var(--border); font-size: 12.5px; }
    .meta-row:last-child { border-bottom: none; }
    .meta-key { color: var(--text3); font-weight: 600; }
    .meta-val { color: var(--text2); font-weight: 600; }
...
<div class="page">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Perbarui konten artikel — <strong style="color:var(--text2)">{{ $berita->judul }}</strong></p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.berita.show', $berita->id) }}" class="btn btn-ghost">
        ...
        <div class="layout">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                                value="{{ old('judul', $berita->judul) }}" placeholder="Tulis judul berita yang menarik...">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ringkasan" class="form-control @error('ringkasan') is-invalid @enderror"
                                rows="3" placeholder="Deskripsi singkat berita (opsional, maks 500 karakter)...">{{ old('ringkasan', $berita->ringkasan) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="konten" id="konten" class="form-control @error('konten') is-invalid @enderror"
                                rows="14" placeholder="Tulis konten berita di sini...">{{ old('konten', $berita->konten) }}</textarea>
                        ...
                        <div class="tab-pane active" id="tab-seo">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror"
                                    value="{{ old('meta_title', $berita->meta_title) }}" placeholder="Judul untuk mesin pencari (opsional)">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                                    rows="2" placeholder="Deskripsi untuk mesin pencari...">{{ old('meta_description', $berita->meta_description) }}</textarea>
                                @error('meta_description')<p class="invalid-feedback">{{ $message }}</p>@enderror
                            </div>
                            <div class="form-group" style="margin-bottom:0">
                                <label class="form-label">Tags</label>
                                <input type="text" name="tags" class="form-control @error('tags') is-invalid @enderror"
                                    value="{{ old('tags', $berita->tags) }}" placeholder="teknologi, pendidikan, sekolah">
                        ...
                        <div class="tab-pane" id="tab-extra">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_penulis" class="form-control @error('nama_penulis') is-invalid @enderror"
                                    value="{{ old('nama_penulis', $berita->nama_penulis) }}" placeholder="Nama penulis (opsional)">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="meta-row">
                            <span class="meta-key">Status saat ini</span>
                        ...
                        @endif
                        <div class="meta-row">
                            <span class="meta-key">Terakhir diperbarui</span>
                        ...
                        <div class="form-group" style="margin-bottom:0">
                            ...
                            <select name="berita_kategori_id" class="form-control @error('berita_kategori_id') is-invalid @enderror">
                                ...
                                @foreach($kategori as $k)
                                    <option value="{{ $k->id }}" {{ old('berita_kategori_id', $berita->berita_kategori_id) == $k->id ? 'selected' : '' }}>
                                        {{ $k->nama }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="thumb-preview-wrap" id="thumbWrap">
                            ...
                            <div id="thumbPlaceholder" {{ ($berita->thumbnail_path || $berita->thumbnail_url) ? 'style=display:none' : '' }}>
                                ...
                                <p class="thumb-upload-text"><strong>Klik untuk ganti</strong> atau seret gambar</p>
                                <p class="form-hint" style="margin-top:4px">PNG, JPG, WEBP — maks 2 MB</p>
                            </div>
                            <img id="thumbPreview" alt="Thumbnail"
                                src="{{ $berita->thumbnail_path ? asset('storage/'.$berita->thumbnail_path) : ($berita->thumbnail_url ?? '') }}"
                                style="{{ ($berita->thumbnail_path || $berita->thumbnail_url) ? '' : 'display:none' }}">
                        </div>
                        ...
                        <div class="form-group" style="margin-top:14px;margin-bottom:0">
                            ...
                            <input type="url" name="thumbnail_url" class="form-control @error('thumbnail_url') is-invalid @enderror"
                                value="{{ old('thumbnail_url', $berita->thumbnail_url) }}" placeholder="https://...">
                        ...
                        <div class="form-group" style="margin-top:14px;margin-bottom:0">
                            ...
                            <input type="text" name="thumbnail_alt" class="form-control"
                                value="{{ old('thumbnail_alt', $berita->thumbnail_alt) }}" placeholder="Deskripsi gambar">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="toggle-wrap">
                            ...
                            <label class="toggle">
                                <input type="checkbox" name="allow_comment" value="1" {{ old('allow_comment', $berita->allow_comment) ? 'checked' : '' }}>
                                <span class="toggle-slider"></span>
                            </label>
                        </div>
                    </div>
